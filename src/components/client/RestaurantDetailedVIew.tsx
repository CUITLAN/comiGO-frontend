...
import MapExplore from '@/components/client/MapExplore'; // Importamos el mapa
...
export default function RestaurantDetailView({ restaurant, menu }: RestaurantDetailViewProps) {
    return (
        <main className="min-h-screen bg-[#FDFBF7] pb-24 relative">
            ...
            <div className="px-6 -mt-12 relative z-10 mb-8">
                ...
                <div className="flex justify-between items-end mb-4">
                    ...
                    <div className="flex items-center gap-1 bg-white px-3 py-1.5 rounded-xl shadow-sm border border-gray-100 mb-2">
                ...
                <p className="text-gray-500 text-sm mb-6">{restaurant.category} • {restaurant.minOrder > 0 ? `Min. $${restaurant.minOrder}` : 'Sin mínimo'}</p>

                {/* GALERÍA DE FOTOS (Igual que en el registro) */}
                ...
                <div className="w-full h-48 rounded-xl overflow-hidden mb-6 relative border border-gray-200 shadow-sm">
                    <MapExplore 
                        // @ts-ignore: Ignoramos tipado estricto temporalmente si hay diferencias menores
                ...
                {/* LISTA DE DETALLES (Iconos y Texto) */}
                ...
                <div className="relative flex py-2 items-center mb-8">
                    ...
                    <span className="flex-shrink mx-4 text-gray-400 text-xs uppercase tracking-wider font-semibold">Publicaciones Activas</span>
                    <div className="flex-grow border-t border-gray-300"></div>
                </div>

                {/* MENÚ / PUBLICACIONES */}
                <div>
                    <h2 className="text-lg font-bold text-[#0C3252] mb-4 flex items-center gap-2">
                        Menú Disponible 
                        <span className="bg-[#4A7729] text-white text-xs px-2 py-0.5 rounded-full">
                            {menu.length}
                        </span>
                    </h2>
